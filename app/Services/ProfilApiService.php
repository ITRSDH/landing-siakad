...
class ProfilApiService
{
    ...
    /**
     * Get Profil Kampus data from API
     * API dirancang untuk single data, jadi tidak perlu ID
     */
    public function getProfilKampus($id = null)
    {
        try {
     ...
     * Karena API hanya mengembalikan satu data, ini sama dengan getProfilKampus()
     */
    public function getActiveProfilKampus()
    {
        // Karena API sudah dirancang untuk single data, langsung ambil dari endpoint utama
        return $this->getProfilKampus();
    }
